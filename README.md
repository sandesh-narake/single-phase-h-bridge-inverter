...
- **Simulation Run Time:** 400 ms (Steady-state achieved).
...
1. A low-frequency **reference sine wave** (representing the desired output AC frequency, e.g., 50Hz/60Hz).
2. A high-frequency **triangular carrier wave** (dictating the switching frequency of the inverter).
...
3. Click the **Run** (Running Man) icon to execute the 400ms transient analysis.
